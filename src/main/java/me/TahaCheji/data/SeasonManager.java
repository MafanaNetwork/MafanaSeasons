...
public class SeasonManager extends BukkitRunnable implements Listener {
    ...
    public void nextDay() {
        ...
        Bukkit.getPluginManager().callEvent(new MSNextDayEvent(world));
    ...
    public Season nextSeason() {
        ...
        Bukkit.getPluginManager().callEvent(new MSNextSeasonEvent(world));
